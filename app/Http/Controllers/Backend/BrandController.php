...
class BrandController extends Controller
{
    ...
    public function BrandStore(Request $request) {
        ...
        [
            'brand_name_en.required' => 'Give Brand English Name',
            'brand_name_bn.required' => 'Give Brand Bangla Name',
            'brand_image_path.required' => 'Input a Brand Image',
        ]);
    ...
    public function BrandUpdate(Request $request) {
        ...
        if($request->file('brand_image_path')) {
            ...
            Brand::findOrFail($brand_id)->update([
                ...
                'brand_slug_en' => strtolower(str_replace(' ', '-', $request->brand_name_en)),
                'brand_slug_bn' => strtolower(str_replace(' ', '-', $request->brand_name_bn)),
                'brand_image_path' => 'upload/brand/'.$name_gen,
            ]);
            $notification = array(
