                                                    ...
                                                    <div class="cart clearfix animate-effect">
                                                        <div class="action">
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <button class="btn btn-primary icon" title="Wishlist"
                            ...
                            <div class="tab-pane" id="category{{ $category->id }}">
                                <div class="product-slider">
                                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme"
                                        ...
                                        @php
                                            $catewiseProducts = App\Models\Product::where('category_id', $category->id)
                                                ->orderBy('id', 'DESC')
                                                ->get();
                                        @endphp

                                        @forelse ($catewiseProducts as $catwiseProduct)
                                            <div class="item item-carousel">
                                                <div class="products">
                                                    <div class="product">
                                                        <div class="product-image">
                                                            <div class="image"> <a
                                                                    href="{{ url('product/details/' . $catwiseProduct->id . '/' . $catwiseProduct->product_slug_en) }}"><img
                                                                        src="{{ asset($catwiseProduct->product_thumbnail) }}"
                                                                        alt=""></a>
                                                            </div>
                                                            <!-- /.image -->
                                                        ...
                                                        <div class="product-info text-left">
                                                            <h3 class="name"><a
                                                                    href="{{ url('product/details/' . $catwiseProduct->id . '/' . $catwiseProduct->product_slug_en) }}">
                                                                    @if (session()->get('language') == 'bangla')
                                                                        {{ $catwiseProduct->product_name_bn }}
                                                                    @else
                                                                        {{ $catwiseProduct->product_name_en }}
                                                                    @endif
                                                                </a>
                                                            </h3>
                                                            <div class="rating rateit-small"></div>
                                                            ...
                                                            <div class="product-price">
                                                                @if ($catwiseProduct->discount_price == null)
                                                                    <span class="price">
                                                                        ${{ $catwiseProduct->selling_price }}
                                                                    </span>
                                                                @else
                                                                    <span class="price">
                                                                        ${{ $catwiseProduct->discount_price }}
                                                                    </span> <span class="price-before-discount">$
                                                                        {{ $catwiseProduct->selling_price }}</span>
                                                                @endif
                                                            </div>
                                                            <!-- /.product-price -->
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image"> <a
                                                    href="{{ url('product/details/' . $featuredProduct->id . '/' . $featuredProduct->product_slug_en) }}"><img
                                                        src="{{ asset($featuredProduct->product_thumbnail) }}"
                                                        alt=""></a> </div>
                                            <!-- /.image -->
                                        ...
                                        <div class="product-info text-left">
                                            <h3 class="name">
                                                <a
                                                    href="{{ url('product/details/' . $featuredProduct->id . '/' . $featuredProduct->product_slug_en) }}">
                                                    @if (session()->get('language') == 'bangla')
                                                    {{ $featuredProduct->product_name_bn }} @else
                                                        {{ $featuredProduct->product_name_en }}
                                                    @endif
                                                </a>
                                            </h3>
                                            <div class="rating rateit-small"></div>
                                            ...
                                            <div class="product-price">
                                                @if ($featuredProduct->discount_price == null)
                                                    <span class="price">
                                                        ${{ $featuredProduct->selling_price }}
                                                    </span>
                                                @else
                                                    <span class="price">
                                                        ${{ $featuredProduct->discount_price }} </span> <span
                                                        class="price-before-discount">$
                                                        {{ $featuredProduct->selling_price }}</span>
                                                @endif
                                            </div>
                                            <!-- /.product-price -->
                                        ...
                                        <div class="cart clearfix animate-effect">
                                            <div class="action">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <button class="btn btn-primary icon" title="Wishlist" type="button"
                                                        id="{{ $featuredProduct->id }}"
                                                        onclick="addToWishlist(this.id)">
                                                        <i class="fa fa-heart"></i>
                                                    </button>
