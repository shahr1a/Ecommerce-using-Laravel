    ...
    foreach ($categories as $category) {
        ...
        if ($category->id == $products[0]->category_id) {
            if (session()->get('language') == 'bangla') {
                $cat = $category->category_name_bn;
            } else {
                $cat = $category->category_name_en;
            }

            $subcategory = App\Models\SubCategory::findOrFail($products[0]->subcategory_id);

            if (session()->get('language') == 'bangla') {
                $subcat = $subcategory->subcategory_name_bn;
            } else {
                $subcat = $subcategory->subcategory_name_en;
            }

            $subsubcategory = App\Models\SubSubCategory::findOrFail($products[0]->subsubcategory_id);

            if (session()->get('language') == 'bangla') {
                $subsubcat = $subsubcategory->subsubcategory_name_bn;
            } else {
                $subsubcat = $subsubcategory->subsubcategory_name_en;
            }
            ...
            <div class='col-md-9'>
                ...
                <div class="search-result-container ">
                    <div id="myTabContent" class="tab-content category-list">
                        <!-- ========================================== Product Grid View ========================================= -->
                        @include('frontend.tags.view_style.grid_view')
                        <!-- ========================================== Product List View ========================================= -->
                        @include('frontend.tags.view_style.list_view')
                    </div>
                    <!-- /.tab-content -->
