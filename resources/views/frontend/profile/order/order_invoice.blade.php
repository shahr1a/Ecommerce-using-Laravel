    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>ProShop</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
                    ProShop Online BD
                    Email:support@proshoponlinebd.com <br>
                    Mob: 1245454545 <br>
                    Banani, Dhaka <br>
            </pre>
            </td>
        ...
        <tr>
            <td>
                <p class="font" style="margin-left: 20px;">
                    <strong>Name:</strong> {{ ucfirst(trans($order->user->name)) }} <br>
                    ...
                    <strong>Address:</strong> {{ $division }}, {{ $district }}, {{ $state }} <br>
        ...
        <tbody>
            ...
            @foreach ($orderItem as $item)
                <tr class="font">
                    ...
                    <td align="center">{{ ucfirst(trans($item->product->product_name_en)) }}</td>
                    <td align="center">
                        @if ($item->size == null)
                        @else
                            {{ $item->size }}
                    ...
                    <td align="center">{{ ucfirst(trans($item->color)) }}</td>
