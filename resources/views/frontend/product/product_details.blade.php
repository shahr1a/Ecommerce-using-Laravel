...
@section('content')
@section('title')
    {{ $product->product_name_en }} - Pro Online Shop
@endsection
                                    ...
                                    @foreach ($multiImg as $item)
                                        <div class="single-product-gallery-item" id="slide{{ $item->id }}">
                                            <a data-lightbox="image-1" data-title="Gallery"
                                                href="{{ asset($item->photo_name) }}">
                                                <img class="img-responsive" alt=""
                                                    src="{{ asset($item->photo_name) }}"
                                                    data-echo="{{ asset($item->photo_name) }}" />
                                            </a>
                                        ...
                                        @foreach ($multiImg as $item)
                                            <div class="item">
                                                <a class="horizontal-thumb active" data-target="#owl-single-product"
                                                    data-slide="1" href="#slide{{ $item->id }}">
